class Design < ApplicationRecord
  ...
  def calculator_settings
    ...
    case self.variants.first.sale_unit.name
    when 'Roll'
      ...
      if length = self.property('roll_length_yards')
        {
            ...
            minimum: self.variants.first.minimum_quantity,
    ...
    when 'Yard'
      ...
      if self.variants.first.minimum_quantity > 1
        parenthetical_note += " This product has a minimum order quantity of #{self.variants.first.minimum_quantity} yards."
      end
    ...
    when 'Meter'
      ...
      if self.variants.first.minimum_quantity > 1
        parenthetical_note += " This product has a minimum order quantity of #{self.variants.first.minimum_quantity} meters."
      end
    ...
    when 'Square Foot'
      {
          note: "Indicate no. of Square Feet<br><span>This product is custom printed. Minimum order quantity of #{self.variants.first.minimum_quantity} square feet. We suggest adding an additional 20-30% overage to be sure you're covered!</span>",
          divisor: 144,
          minimum: self.variants.first.minimum_quantity,
    ...
    when 'Set'
      ...
      {
          note: "Indicate no. of Sets of #{quantity} Panels<br><span>Minimum order quantity of #{self.variants.first.minimum_quantity} set. We suggest adding an additional 20-30% overage to be sure you're covered!</span>",
          divisor: divisor,
          minimum: self.variants.first.minimum_quantity,
          sale_unit: ['set', 'sets']
      }.to_json
